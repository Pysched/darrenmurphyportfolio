...
### Acknowledgements
Each aspect of the code that I used that was not previously know was attained through the bootstrap home page and codepens.
The work section layout of the grid system was inspored by the haley shicfer example provided and modifed to suit my needs
